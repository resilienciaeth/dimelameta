...
const Home = () => (
  <div className="flex bg-dime-2 justify-center px-0 flex-col">
    <div className="w-full h-[110vh] bg-dime-1 minmd:w-4/5">
    ...
    <div className="h-screen mt-[8rem] bg-dime-2">
      ...
      <div className=" bg-dime-2 mt-[3rem] flex justify-start flex-row overflow-hidden no-scrollbar overflow-x-scroll">
        <div className="text-black bg-dime-2 min-w-[289px] ml-10 px-4">
        ...
        <div className="text-black bg-dime-2 min-w-[289px] px-4">
          <Image src={images.pepeposter2} />
        </div>
      </div>
    </div>
    <div>
      <div className="flex bg-dime-2 mt-[12rem]">
    ...
    <div className="h-[400px] bg-white mt-20">
      <div className="flex mt-10 flex-row justify-between items-center px-12">
